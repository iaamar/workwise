...
const ProjectSettings = () => {
  ...
  return (
    <div className="mt-10 flex h-full flex-col py-6 px-5">
      <form
      ...
      >
        ...
        <div className="flex justify-start">
          <div>
            <label className="text-label font-medium pr-3">
          ...
          {/* End Date Picker */}
          <div>
            <label className="text-label font-medium pl-3 pr-3">
        ...
        <div className="flex justify-between">
          <AlertDialog.Root>
            {isUserTheProjectOwner ? (
              <AlertDialog.Trigger
                className={
                  "flex align-center items-center gap-1 cursor-pointer border-none text-sm mt-1 px-4 py-2 text-white rounded bg-error-900  " +
                  `${
                    !isUserTheProjectOwner
            ...
            <AlertDialog.Portal>
              ...
              >
                ...
                >
                  <AlertDialog.Cancel
                    className={
                      "flex align-center items-center gap-1 cursor-pointer border-none text-sm mt-1 px-4 py-2 bg-primary-900 text-white rounded hover:bg-primary-700 focus:outline-none focus:shadow-outline-primary-300 active:bg-primary-800"
                    }
                    asChild
                  >
                  ...
                  <AlertDialog.Action
                    className={
                      "flex align-center items-center gap-1 cursor-pointer text-sm mt-1 px-4 py-2 text-white rounded bg-error-900"
                    }
                    asChild
                  >
                    <Link to="/projects">
                      <button
                        className="text-white rounded bg-error-900 focus:outline-none "
